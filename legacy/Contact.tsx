...
export default function Contact({ onSubmitted }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmitted("Заявка успешно отправлена!");
    setName("");
    setPhone("");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="reveal border border-[var(--border-brand)] bg-[var(--bg2)] p-6 sm:p-8 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <button
                type="submit"
                className="w-full py-4 bg-[var(--olive)] text-white border-none rounded-[2px] text-[0.75rem] font-bold tracking-[2px] uppercase cursor-pointer transition-all duration-300 hover:bg-[var(--olive-light)]"
              >
                Отправить заявку
              </button>
