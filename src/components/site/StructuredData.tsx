...
const WEBSITE = {
  ...
  inLanguage: "ru-RU",
  description:
    "Маскировка нового поколения — ИК-защитная экипировка: чехлы на рюкзаки, накидки, костюмы из экранирующих тканей.",
};
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Да. Материал выдерживает 30+ циклов стирки без потери защитных свойств. Рекомендуем деликатный режим при 30 °C.",
  },
  {
