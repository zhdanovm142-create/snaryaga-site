...
const FAQS: QA[] = [
  ...
  },
  {
    ...
    a: "Да. Материал выдерживает 50+ циклов стирки без потери защитных свойств. Рекомендуем деликатный режим при температуре 30 °C, без отбеливателей и машинной сушки.",
    topic: "care",
  },
  {
    q: "Сколько занимает изготовление заказа?",
    a: "Стандартные позиции (рюкзаки 20/50/100 л) — от 3 до 5 дней. Костюмы «Бугор» — 4–12 дней в зависимости от модели. Кастомные решения и индивидуальный пошив — от 2 недель. Сроки согласуем с менеджером при оформлении заявки.",
    topic: "order",
  },
  {
