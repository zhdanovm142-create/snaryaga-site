...
const POSTS = [
  ...
  },
  {
    ...
    tag: "Материал",
    tagColor: "coyote",
    title: "Новая экранирующая ткань: 30+ циклов стирки",
    excerpt:
      "R&D-лаборатория завершила тестирование обновлённой ткани. Защитные свойства сохраняются после 30 циклов стирки при 30 °C — без деградации слоёв.",
    stat: "30+",
